...
\begin{itemize}
    \item \marginnote{2/10:}Should take twice as long as a short report.
    ...
    \begin{itemize}
        \item Compare the gas-phase and chloroform solution-phase \ce{I2} spectra.
        \begin{itemize}
            ...
            \begin{itemize}
                \item In particular, don't use the gas-phase \ce{I2} data we collected \emph{at all}. To use it, we'd need $I_0$ from the instrument but we can't get this because the lab is closed/contaminated. Thus, we can't calculate absorbance from our data.
            ...
            \end{itemize}
        \end{itemize}
        \item Discuss similarities and differences that you observe in a molecular context.
        \begin{itemize}
            \item Focus on molecular mechanics??
            \item Good questions to answer here include the following.
            \item ...
        \end{itemize}
        \item Explain how interpreting the solution spectrum differs from interpreting the gas-phase one.
        \begin{itemize}
            \item Focus on data analysis??
            \item Good questions to answer here include the following.
            \item ...
        \end{itemize}
        \item Why don't you see fine structure on the solution spectrum?
        \begin{itemize}
            \item Good questions to answer here include the following.
            \item ...
        \end{itemize}
        \item How would the electronic potential energy surface, the vibrations, and the rotations differ in solution?
        \begin{itemize}
            \item Are these last four questions general prompts and you want us to speak in that direction?? Are there subtle differences between everything that I'm missing?
            \item Good questions to answer here include the following.
            \item ...
        \end{itemize}
    \end{itemize}
    \item What kind of error analysis do I need?
    \begin{itemize}
        \item No calculations.
        \item Address what could have happened in experimentation to cause error, how that experimental error could impact the final results, how you see proof of error in your analysis, etc.
    \end{itemize}
